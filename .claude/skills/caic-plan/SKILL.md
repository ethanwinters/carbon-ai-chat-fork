...
| ------------- | ------------------------------------ | ------------------------------------------------------------------------------- | ------------- |
| Plan → issues | Producing an epic and its sub-issues | The issues, in the format under [Acceptance criteria](#acceptance-criteria)     | None          |
...
- **Nothing new here.** Every criterion projects a parent one level up — an epic outcome, a plan's Done when item, or the Goal on a standalone issue. The rule is [the spine](#the-spine).
