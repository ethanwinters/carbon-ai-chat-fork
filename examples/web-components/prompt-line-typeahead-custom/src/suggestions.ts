...
/**
 * Static fixture data for the typeahead-custom example.
 *
 * Demonstrates: the shape a real autocomplete resolver must return so
 * `renderCustomList` and the chat's selection pipeline can drive the
 * dropdown without any network access.
 *
 * APIs exercised:
 *   - `SuggestionItem`
 *
