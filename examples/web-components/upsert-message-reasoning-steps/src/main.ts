...
/**
 * Example: Carbon AI Chat — Upsert message / Reasoning steps (Web components)
 *
 ...
 * trace — picked via a dropdown on the welcome message, all delivered through
 * `upsertMessage` instead of the chunk-based streaming API.
 *
 * APIs exercised:
