 ...
 * `groupId` / `groupTitle`) that the AUTOCOMPLETE resolver in `main.ts`
 * filters against. Items sharing the same `groupId` are rendered under a
 * group heading; items without one are flat.
 *
 * APIs exercised:
