...
/**
 * Curated suggestion fixture for the typeahead example.
 *
 * Demonstrates: the shape of `SuggestionItem` entries that the
 * `SuggestionType.AUTOCOMPLETE` resolver in `main.ts` filters against.
 *
 * APIs exercised:
 *   - `SuggestionItem` (`id`, `label`, `description`)
 *
...
// Replace with a real production implementation that fetches suggestions
// from your search index or assistant catalog rather than hard-coding them.
