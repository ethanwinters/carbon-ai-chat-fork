...
/**
 * Custom history loader for the chat-history-fullscreen example.
 *
 * Demonstrates: synthesizing a `HistoryItem[]` transcript from a request
 * label so a stored conversation can be rehydrated in the chat UI.
 *
 * APIs exercised:
