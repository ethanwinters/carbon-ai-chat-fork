module.exports = {
  ...
  transformIgnorePatterns: [
    ...
    "node_modules/(?!(?:@lit|lit|lit-html|lit-element|@lit-labs|@carbon|lodash-es|@floating-ui|uuid|csv-stringify|compute-scroll-into-view|@ibm|classnames|tabbable|swiper|dayjs|dompurify|focus-trap-react|intl-messageformat|markdown-it|@formatjs|@codemirror|@lezer|crelt|style-mod|w3c-keyname|flatpickr)/)",
  ],
