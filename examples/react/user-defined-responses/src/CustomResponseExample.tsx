...
/**
 * Sample React component rendered as a user-defined response.
 *
 * Demonstrates: a host-owned component that consumes back-end-supplied data,
 * runs its own local state/effects, and reflects whether its parent message
 * is the latest in the conversation.
 *
 * APIs exercised:
 *   - host CSS via `./CustomResponseStyles.css`
 *
