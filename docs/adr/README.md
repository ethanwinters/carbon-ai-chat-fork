...
- **A break nobody had spotted** goes into Consumer impact.
- **A constraint nobody knew about** usually changes the proposal.

Consumer impact, Drawbacks, and Alternatives are optional. A record adds one when there's an argument to make there, and leaves it out rather than carrying a heading with "None." under it.
