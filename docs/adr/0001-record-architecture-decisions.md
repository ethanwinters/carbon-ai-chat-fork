...
- **The section list is fixed.** A record uses these headings in this order, so a proposal that wants a section of its own has to fit it under one of them, or change the format for everyone.
