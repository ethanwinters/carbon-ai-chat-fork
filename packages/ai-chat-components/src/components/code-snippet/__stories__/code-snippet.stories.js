...
export class TokenShowcase<T extends TokenSwatch> {
  ...
  static readonly palette: Record<TokenGroup, string> = {
    [TokenGroup.Keyword]: "--cds-code-snippet-editor-keyword",
    [TokenGroup.Variable]: "--cds-code-snippet-editor-variable",
    [TokenGroup.String]: "--cds-code-snippet-editor-string",
    [TokenGroup.Number]: "--cds-code-snippet-editor-number",
    [TokenGroup.Comment]: "--cds-code-snippet-editor-comment",
  };

  #pattern = /--cds-code-snippet-editor-[a-z-]+/g;
