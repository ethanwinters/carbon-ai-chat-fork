...
## `<cds-aichat-code-snippet-card>` attributes, properties and events

Note: This component forwards all properties to the inner `<cds-aichat-code-snippet>` component and wraps it in a `<cds-aichat-card>` for consistent AI Chat styling.
