...
Use `cds-aichat-code-snippet-tile-container` to present generated code with syntax highlighting, copy affordances, and optional expand/collapse controls. The tile container wraps a `cds-aichat-code-snippet` instance, you can show the code snippet without a tile container by using `cds-aichat-code-snippet`, which has the same API.
...
<cds-aichat-code-snippet-tile-container highlight>
