...
const CODE_SNIPPET_TILE_CONTAINER_COMPONENT_TAG_NAME =
  "cds-aichat-code-snippet-tile-container";

/**
 * AI Chat code snippet wrapper that places the snippet inside a Carbon tile.
 *
 * @element cds-aichat-code-snippet-tile-container
 */
@carbonElement("cds-aichat-code-snippet-tile-container")
...
declare global {
  interface HTMLElementTagNameMap {
    [CODE_SNIPPET_TILE_CONTAINER_COMPONENT_TAG_NAME]: CDSAIChatCodeSnippetTileContainer;
  }
}

export { CODE_SNIPPET_TILE_CONTAINER_COMPONENT_TAG_NAME };
