      ...
      <HistoryPanelItems>
        <HistoryPanelMenu expanded title="Search results">
          ...
          <HistorySearchItem
            ...
            date="Monday, 12:04 PM"></HistorySearchItem>
          <HistorySearchItem
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        active. Use this to validate the value and pass the result back via{' '}
        <code>renameInvalid</code> and <code>renameInvalidMessage</code> props.
      </td>
      <td>
...
function SearchResults() {
  ...
  return (
    <HistorySearchItem
      ...
      onSelected={handleSearchItemSelected}></HistorySearchItem>
  );
}
```
...
function ChatHistory() {
  ...
  return (
    isHistoryVisible && (
      <HistoryShell>
        <HistoryHeader headerTitle="Chats" onClose={handleHeaderClose} />
        {/* ... rest of content */}
      </HistoryShell>
    )
  );
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        result back via <code>invalid</code> and <code>invalidMessage</code>{' '}
        props.
      </td>
      <td>
        • <code>value</code> (string) - The current input value
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <code>nextItemId</code>, and <code>deletedItemWasSelected</code>.
      </td>
    </tr>
  </tbody>
</table>
