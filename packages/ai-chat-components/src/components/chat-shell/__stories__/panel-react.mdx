...
The `<ChatPanel>` component wraps the `cds-aichat-panel` web component to create overlay panels that display on top of the chat interface inside React applications. Panels support priority management, animations, and flexible content layouts with header, body, and footer slots.

<Canvas of={PanelReactStories.Default} />
...
<Canvas of={PanelReactStories.MultiplePanels} />
