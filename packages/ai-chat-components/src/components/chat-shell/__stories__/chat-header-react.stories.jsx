...
import { Button, ContentSwitcher, Switch, AILabel } from "@carbon/react";
import { Close, Restart, OverflowMenuVertical, ChevronLeft } from "@carbon/icons-react";
  ...
  argTypes: {
    ...
    fixedActions: {
      ...
      mapping: {
        ...
        "custom button": (
          <div slot="fixed-actions">
            <Button onClick={() => console.log("Custom button clicked")} size="md">
              Custom
            </Button>
          </div>
        ),
    ...
    aiLabel: {
      table: { category: "slot" },
      control: "boolean",
      description: "AI Label slot in the chat header component `slot='decorator'`",
    },
  },
};
