...
class CDSAIChatShell extends LitElement {
  ...
  protected firstUpdated(changedProperties: PropertyValues) {
    ...
    this.slotObserver.connect(() => {
      ...
      this.hasHeaderContent = state.hasHeaderContent;
      this.hasHeaderAfterContent = state.hasHeaderAfterContent;
      this.hasFooterContent = state.hasFooterContent;
      this.hasInputContent = state.hasInputContent;
      this.hasInputAfterContent = state.hasInputAfterContent;
      this.hasInputBeforeContent = state.hasInputBeforeContent;
