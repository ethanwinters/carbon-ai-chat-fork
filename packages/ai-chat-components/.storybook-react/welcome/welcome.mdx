...
> **Note:** Individual components (like `Card`) may have their own border radius properties that automatically update `--cds-aichat-rounded-modifier-radius` in their scope. See component-specific documentation for details.
