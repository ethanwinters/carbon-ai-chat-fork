...
export const defaultLayout = (context, template, props) => {
  ...
  const headerNav = carbonHeaderNav(context, props, navigationGroups);
    ...
    JSX.createElement(
      ...
      JSX.createElement(
        "cds-modal",
        {
          ...
          "modal-heading": "Search documentation",
          "modal-label": props.project.name,
          size: "md",
        },
        JSX.createElement(
          "div",
          { id: "carbon-search-content" },
          JSX.createElement(JSX.Raw, {
            html: "<!-- TypeDoc search will be moved here -->",
          }),
        ),
      ),
