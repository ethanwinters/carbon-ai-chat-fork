...
- Kind: TypeAlias
- Category: Config
- Reference: https://chat.carbondesignsystem.com/version/v1.19.0-rc.0/docs/types/Type_reference.BaseSuggestionConfig.html
...
```ts
type BaseSuggestionConfig = _BaseSuggestionConfig
```
