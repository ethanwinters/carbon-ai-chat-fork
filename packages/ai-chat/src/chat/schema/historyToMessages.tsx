...
function addMessage(
  ...
  // the `undefined` key when the caller omits an id (e.g. SYSTEM date separators).
  addDefaultsToMessage(message as Parameters<typeof addDefaultsToMessage>[0]);
  // addDefaultsToMessage initialises from_history to false; override to true for all history items.
